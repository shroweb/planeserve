...
export function AttachmentIcon(p: IconProps) {
  return base(
    p,
    <path d="M20 11.5 11.6 19.9a5 5 0 0 1-7.1-7.1l8.5-8.5a3.3 3.3 0 0 1 4.7 4.7l-8.5 8.5a1.7 1.7 0 0 1-2.4-2.4l7.8-7.8" />,
  );
}
...
export function PhoneIcon(p: IconProps) {
  return base(
    p,
    <path d="M6.5 3.5 9 4l1 4-1.8 1.4a13 13 0 0 0 5.4 5.4L16 13l4 1 .5 2.5a1.8 1.8 0 0 1-1.9 2.2A14.5 14.5 0 0 1 4.3 5.4 1.8 1.8 0 0 1 6.5 3.5Z" />,
  );
}
...
const ICON_MAP = {
  ...
  takeoff: TakeoffIcon,
  team: TeamIcon,
  "tech-log": TechLogIcon,
  trace: TraceIcon,
  triage: TriageIcon,
  turbine: TurbineIcon,
  updates: UpdatesIcon,
  upload: UploadIcon,
  "verified-doc": VerifiedDocIcon,
} as const;
