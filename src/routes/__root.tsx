  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Retained AOG support for private and business aircraft, with smart aircraft profiles, sourcing triage and operational updates.",
      },
  ...
  return (
    <html lang="en">
      <head>
        <HeadContent />
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-ZW3MNRX6B2" />
        <script
